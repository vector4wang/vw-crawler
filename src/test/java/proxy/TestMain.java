...
public class TestMain {
	public static void main(String[] args) {
		...
		Proxy2 proxy21 = new Proxy2("170.245.173.234",53281);
		...
		new VWCrawler.Builder().setUrl("http://2018.ip138.com/ic.asp").setHeader("User-Agent",
				...
				.setTimeOut(5000).setRetryCount(5).setProxys(ps).setAbsProxyExtracter(new SimpleProxy()).setPageParser(new CrawlerService() {
			@Override
