 ...
 * Description:
 */
public class CrawlerThead implements Runnable  {

    private Logger logger = Logger.getLogger(CrawlerThead.class.getName());
    private VWCrawler vwCrawler;


    public CrawlerThead(VWCrawler vwCrawler) {
    ...
    private void process(String url) {
        ...
        try {
            ...
            if (document != null) {
                ...
                Type[] type = ((ParameterizedType) vwCrawler.getCrawlerService().getClass().getGenericSuperclass()).getActualTypeArguments();
